...
def get_url(year: str, resolution: str) -> str:
    year_int = int(year)
    if year_int == 2013:
        req_url = f"https://www2.census.gov/geo/tiger/GENZ{year}/cb_{year}_us_division_{resolution}.zip"
    elif year_int >= 2014:
        req_url = f"https://www2.census.gov/geo/tiger/GENZ{year}/shp/cb_{year}_us_division_{resolution}.zip"
