...
def get_url(year: str) -> str:
    ...
    if year_int >= 2017:
        req_url = f"https://www2.census.gov/geo/tiger/TIGER{year}/COASTLINE/tl_{year}_us_coastline.zip"
    elif year_int >= 2011:
        req_url = f"https://www2.census.gov/geo/tiger/TIGER{year}/COAST/tl_{year}_us_coastline.zip"
