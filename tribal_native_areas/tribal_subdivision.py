...
def get_url(geom_type: str, year: str) -> str:
    ...
    if geom_type == "Cartographic":
        if year_int == 2013:
            req_url = f"https://www2.census.gov/geo/tiger/GENZ{year}/cb_{year}_us_aitsn_500k.zip"
        elif year_int >= 2014:
            req_url = f"https://www2.census.gov/geo/tiger/GENZ{year}/shp/cb_{year}_us_aitsn_500k.zip"
    else:
        if year_int >= 2015:
            req_url = f"https://www2.census.gov/geo/tiger/TIGER{year}/AITSN/tl_{year}_us_aitsn.zip"
        elif year_int >= 2013:
            req_url = f"https://www2.census.gov/geo/tiger/TIGER{year}/AITS/tl_{year}_us_aitsn.zip"
